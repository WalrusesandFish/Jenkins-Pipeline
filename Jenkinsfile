    ...
    stages {
        stage("Build") {
            steps {
                ...
                You need to specify at least one build automation tool e.g., Maven."""
            }
        }
        ...
        stage("Code Analysis") {
            steps {
                ...
                Research and select a tool to analyze your code using Jenkins."""
            }
        }
        stage("Security Scan") {
            steps {
                echo """perform a security scan on the code using a tool to identify any vulnerabilities. 
                Research and select a tool to scan your code."""
            }
            post {
                always {
                    emailext(
